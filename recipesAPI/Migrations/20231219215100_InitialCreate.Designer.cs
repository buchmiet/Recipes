...
namespace recipesAPI.Migrations
{
    ...
    [Migration("20231219215100_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("recipesCommon.DataAccess.RecipesDbContext+IngredientAmount", b =>
                {
            ...
            modelBuilder.Entity("recipesCommon.DataAccess.RecipesDbContext+RecipeIngredientAmount", b =>
                {
                    b.Property<int>("RecipeIngredientAmountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("RecipeIngredientAmountId");

                    b.HasIndex("IngredientAmountId");
            ...
            modelBuilder.Entity("recipesCommon.DataAccess.RecipesDbContext+IngredientAmount", b =>
                {
                    b.HasOne("recipesCommon.DataAccess.RecipesDbContext+IngredientAmountType", "IngredientAmountType")
                        .WithMany()
                        .HasForeignKey("IngredientAmountTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("recipesCommon.DataAccess.RecipesDbContext+Ingredient", "Ingredient")
                        .WithMany()
                    ...
                    b.Navigation("IngredientAmountType");
                });
            ...
            modelBuilder.Entity("recipesCommon.DataAccess.RecipesDbContext+RecipeIngredientAmount", b =>
                {
                    b.HasOne("recipesCommon.DataAccess.RecipesDbContext+IngredientAmount", "IngredientAmount")
                        .WithMany()
                        .HasForeignKey("IngredientAmountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
