...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("recipesApi.DataAccess.RecipesDbContext+IngredientAmount", b =>
                {
            ...
            modelBuilder.Entity("recipesApi.DataAccess.RecipesDbContext+RecipeIngredientAmount", b =>
                {
            ...
            modelBuilder.Entity("recipesApi.DataAccess.RecipesDbContext+IngredientAmount", b =>
                {
                    b.HasOne("recipesApi.DataAccess.RecipesDbContext+IngredientAmountType", "IngredientAmountType")
                        .WithMany()
                        .HasForeignKey("IngredientAmountTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("recipesApi.DataAccess.RecipesDbContext+Ingredient", "Ingredient")
                        .WithMany()
            ...
            modelBuilder.Entity("recipesApi.DataAccess.RecipesDbContext+RecipeIngredientAmount", b =>
                {
                    b.HasOne("recipesApi.DataAccess.RecipesDbContext+IngredientAmount", "IngredientAmount")
                        .WithMany()
